...
public class Pusher {
	 ...
	 */
	private final static String pusherApplicationId = System.getenv("PUSHER_APP_ID");
	
	/**
	 * Pusher Application Key
	 */
	private final static String pusherApplicationKey = System.getenv("PUSHER_APP_KEY");
	
	/**
	 * Pusher Secret
	 */
	private final static String pusherApplicationSecret = System.getenv("PUSHER_APP_SECRET");
